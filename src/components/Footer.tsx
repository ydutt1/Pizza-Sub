          ...
          <div className="md:col-span-2">
            ...
            <div className="flex gap-3">
              ...
              <a
                ...
                className="w-10 h-10 rounded-md border border-espresso-700/15 text-espresso-600 hover:border-[#E1306C] hover:text-[#E1306C] transition-colors flex items-center justify-center"
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 rounded-md border border-espresso-700/15 text-espresso-600 hover:border-[#1877F2] hover:text-[#1877F2] transition-colors flex items-center justify-center"
                aria-label="Facebook"
              >
                <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
